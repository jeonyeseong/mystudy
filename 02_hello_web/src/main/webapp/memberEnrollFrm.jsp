    ...
    <!-- table#enroll>(tr>th+td)*10 -->
        <table id="enroll">
            <tr>
                ...
                <td>
                    <input type="text" name="userId" id="userId" value="yooonbj">
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="userName" id="userName" value="전예성"> 
                </td>
            </tr>
            <tr>
                <th>주민번호<span class="req">*</span></th>
                <td>
                    <input type="text" name="ssn1" id="ssn1" class="short" value="940801">-
                    <input type="password" name="ssn2" id="ssn2" class="short" value="1546715">
                </td>
            </tr>
            <tr>
                <th>이메일<span class="req">*</span></th>
                <td>
                    <input type="email" name="email" id="email" value="afsadf@naver.com">
                </td>
            </tr>
            <tr>
                ...
                <!-- input:text[name=tel$]#tel$.phone*3 -->
                    ...
                    <input type="text" name="tel2" id="tel2" class="phone" value="4338">-
                    <input type="text" name="tel3" id="tel3" class="phone" value="0748">
                </td>
            </tr>
            <tr>
                <th>직업</th>
