...
/**
 * Servlet implementation class QuestionboardEnrollServlet
 */
@WebServlet("/community/questionboardEnroll")
public class QuestionboardEnrollServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			System.out.println("[QuestionoardEnrollServlet] saveDirectory = " + saveDirectory);
...
//			FileRenamePolicy policy = new DefaultFileRenamePolicy();
			...
			Questionboard questionboard = new Questionboard(0, title, writer, content, 0, null, null, 0);
			...
			System.out.println("[QuestionboardEnrollServlet] questionboard = " + questionboard);
